...
public class MePullScrollView extends ScrollView {
    ...
    public MePullScrollView(Context context) {
        super(context);
        init(context, null);
    }

    public MePullScrollView(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(context, attrs);
    }

    public MePullScrollView(Context context, AttributeSet attrs, int defStyle) {
    ...
    private void init(Context context, AttributeSet attrs) {
        ...
        if (null != attrs) {
            TypedArray ta = context.obtainStyledAttributes(attrs, R.styleable.MePullScrollView);

            if (ta != null) {
                mHeaderHeight = (int) ta.getDimension(R.styleable.MePullScrollView_headerHeight, -1);
                mHeaderVisibleHeight = (int) ta.getDimension(R.styleable
                        .MePullScrollView_headerVisibleHeight, -1);
                ta.recycle();
            }
        }
    }
